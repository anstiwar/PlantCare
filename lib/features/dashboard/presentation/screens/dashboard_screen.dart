...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  void _addPlant(Map<String, dynamic> plant) async {
  ...
  void _removePlant(String plantId, String name) async {
    final repository = ref.read(plantRepositoryProvider);
  ...
  void _openPlantDetail(Map<String, dynamic> plant) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => PlantDetailScreen(
          plant: plant,
          onDelete: () => _removePlant(plant['id'] as String, plant['name'] as String),
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> pages = [
      _buildHomeTab(plantsAsync),
      _buildPlantsTab(plantsAsync),
      _buildSettingsTab(),
    ];
  ...
  // ==========================================
  Widget _buildHomeTab(AsyncValue<List<Map<String, dynamic>>> plantsAsync) {
    return plantsAsync.when(
      data: (plants) {
        ...
        final needCareCount = plants.where((p) => p['health'] == 'Needs Attention').length;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _buildStatCard('Total Plants', '$plantCount', Icons.local_florist_rounded, const Color(0xFF2E7D32)),
                        const SizedBox(width: 12),
                        _buildStatCard('Tasks Today', '${_tasks.length}', Icons.task_alt_rounded, Colors.blue),
                        const SizedBox(width: 12),
                        _buildStatCard('Need Care', '$needCareCount', Icons.warning_amber_rounded, Colors.orange),
                      ],
                    ),
                    const SizedBox(height: 24),
                    // Section Title
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              backgroundColor: (task['color'] as Color).withOpacity(0.15),
      ...
      error: (error, stackTrace) => Center(
        child: Text('Failed to load plants: $error', textAlign: TextAlign.center),
      ),
    );
  }
  ...
  // ==========================================
  Widget _buildPlantsTab(AsyncValue<List<Map<String, dynamic>>> plantsAsync) {
    return plantsAsync.when(
      data: (plants) {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: ['All', 'Living Room', 'Balcony', 'Bedroom', 'Study Room', 'Kitchen', 'Bathroom', 'Garden']
                        .map((category) {
                  ...
                  child: filteredPlants.isEmpty
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              Icon(Icons.eco_rounded, size: 80, color: Colors.grey.withOpacity(0.3)),
                              const SizedBox(height: 16),
                              Text(
                                plants.isEmpty
