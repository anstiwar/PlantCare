...
class _$HistoryModelImpl implements _HistoryModel {
  ...
  @override
  String toString() {
    return 'HistoryModel(id: $id, plantId: $plantId, actionType: $actionType, timestamp: $timestamp, notes: $notes, photoPath: $photoPath, createdAt: $createdAt)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, plantId, actionType,
      timestamp, notes, photoPath, createdAt);
